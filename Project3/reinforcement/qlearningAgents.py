...
class QLearningAgent(ReinforcementAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        return self.Q[self.getKey(state, action)]
    ...
    def computeActionFromQValues(self, state):
        ...
        for action in self.getLegalActions(state):
            ...
            if bstScore is None or bstScore < score:
                bstScore = score
                possible = []
...
#https://en.wikipedia.org/wiki/Q-learning
    def update(self, state, action, nextState, reward):
        ...
        """
        self.Q[self.getKey(state, action)] = self.getQValue(state, action) + self.alpha * (reward + self.discount * self.computeValueFromQValues(nextState) - self.getQValue(state, action))
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        ret = sum([ features[a] * self.weights[a] for a in self.weights.keys() ])
    ...
    def update(self, state, action, nextState, reward):
        ...
        for a in features.keys():
            self.weights[a] = self.weights[a] + self.alpha * dif * features[a]
